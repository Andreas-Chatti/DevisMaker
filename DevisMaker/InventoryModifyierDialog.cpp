...
void InventoryModifyierDialog::on_removeItemButton_clicked()
{
    ...
    // TODO : Directement implenter les changements de la liste d'inventaire de la fenêtre dans la fenêtre principale
...
void InventoryModifyierDialog::displayInventory()
{
    ...
    ui.titleLabel->setText(QString::fromUtf8("Inventaire (%1 éléments)").arg(objects.size()));
